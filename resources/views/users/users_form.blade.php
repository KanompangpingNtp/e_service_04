...
<div class="container">
    ...
    <form action="{{ route('formsCreate') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 col-md-4">
            <label for="complaintName" class="form-label">ขอร้องทุกข์ร้องเรียนกรณี<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id="complaintName" name="complaintName" placeholder="โปรดระบุ" required>
        </div>
        <div class="mb-3 col-md-7">
            <label for="complaintDetails" class="form-label">ขอให้ดําเนินการ<span class="text-danger">*</span></label>
